...
export default function AboutUs() {
  return (
    <section id="about" className="bg-[#FAF9F6] py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-5">
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="font-dm text-gray-600 text-lg leading-relaxed"
          >
            Aces for Youth was founded by{' '}
            <strong className="text-[#2D6A4F]">Christopher Lum</strong>, a 9th grader and
